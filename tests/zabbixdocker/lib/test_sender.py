...
from zabbixdocker.lib.zabbix import ZabbixMetric, ZabbixSender, ZabbixResponse
...
'''
    ...
    def test_init_config_default(self):
        ...
        f = file.read()
        with patch('zabbixdocker.lib.zabbix.open', mock_open(read_data=f)):
    ...
    @patch('zabbixdocker.lib.zabbix.socket.socket', autospec=True)
